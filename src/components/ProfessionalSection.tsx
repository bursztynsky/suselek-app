                    ...
                    <div className={styles.featuresGrid}>
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Przestronne klatki i zabudowane, sterylne kojce. Wolnostojące boksy dla świnek morskich.
                        ...
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Zwierzęta zamieszkają ze mną – mam dla nich wydzielony i odpowiednio przygotowany cały
                                parter naszego domu w Nadarzynie pod Warszawą.
                            </p>
                        </div>
                        ...
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Opieka po zabiegach, podawanie leków, szybkie reagowanie na pierwsze objawy problemów
                                zdrowotnych
                            </p>
                        </div>
                    </div>
