        ...
        <section id="home" className={styles.home}>
            <div className={`${styles.homeContainer} container`}>
                <div className={styles.homeContent}>
                    <h1 className={styles.homeTitle}>Hotelik dla <span>królików i gryzoni</span> pod Warszawą</h1>
                    <p className={styles.homeSubtitle}>
                        W hotelu “Susełek” łączymy doświadczenie weterynaryjne z domową atmosferą.
                        Twoje zwierzę zamieszka z nami – na parterze naszego domu, w przestrzeni stworzonej specjalnie z
